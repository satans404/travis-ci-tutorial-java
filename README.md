[![Build Status](https://app.travis-ci.com/satans404/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/satans404/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/satans404/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/satans404/travis-ci-tutorial-java)
...
[Click here for the example using GitHub Actions instead of Travis CI](https://github.com/satans404/github-ci-tutorial-java)

# How To Start

1. [Fork](https://github.com/satans404/travis-ci-tutorial-java/fork) this Repository
...
- Add your repository (you can go there directly by going to https://codecov.io/gh/satans404/travis-ci-tutorial-java)
...
[Open an Issue](https://github.com/satans404/travis-ci-tutorial-java/issues/new)!
